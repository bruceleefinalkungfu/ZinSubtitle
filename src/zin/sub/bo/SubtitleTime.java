...
public class SubtitleTime {
	...
	public final short millSec;

	public SubtitleTime(String subtitleTimeStr) {
		String [] hourMinSecMilliArr = subtitleTimeStr.split(ZinRegEx.literal(HOUR_MIN_SEC_SEPARATOR).or(ZinRegEx.literal(SEC_MILLI_SEPARATOR)).getRegEx());
	...
	public String getStringValue() {
		...
		+ SEC_MILLI_SEPARATOR + zeroPrefixedTime(millSec);
	}
	...
	public SubtitleTime operate(Operation operation, SubtitleTime with) {
		short opMill = operate(operation, this.millSec , with.millSec);
